...
public class CandidateUI implements Serializable{
    private String name;
    ...
    public CandidateUI(Long id, String name, String about) {
        this.id = id;
        this.name = name;
        this.about = about;
    }

    public CandidateUI(Long id, String name, String about, Integer count) {
        this.name = name;
        this.about = about;
        this.id = id;
        this.count = count;
